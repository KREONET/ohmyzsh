...
# Put it all together!
TAG1=""
[[ -f /etc/tag1 ]] && TAG1=$(echo "[$(cat /etc/tag1)]")
TAG2=""
[[ -f /etc/tag2 ]] && TAG2=$(echo "[$(cat /etc/tag2)]")
PROMPT="[!%!]$TAG1$TAG2$DALLAS_CURRENT_TIME_\$(ruby_prompt_info)$DALLAS_CURRENT_MACH_$DALLAS_CURRENT_LOCA_ $DALLAS_CURRENT_USER_$DALLAS_PROMPT_CHAR_ "
